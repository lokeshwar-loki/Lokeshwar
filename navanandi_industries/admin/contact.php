      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="p-md-4 p-3">
          ...
          <div class="table-responsive ">
            <?php
              $bussinessEnquiryRequestSQL = "SELECT * FROM `enquiry` WHERE type = 3 ORDER BY `enquiry_id` DESC";
              ...
              if(mysqli_num_rows($bussinessEnquiryRequestResult) > 0){
                ...
                print('<div class="alert alert-primary text-center small m-0">You have no Contact Requests</div>');
              }
            ?>
          </div>
          </div>
